...
public class BMI {
    public static void main(String[] args) {
        ...
        try {
            while (!stop) {
                System.out.println("Would you like to measure your BMI in metric or imperial? (Type 'exit' to exit)");
                String MorI = scanner.nextLine().toLowerCase();
                ...
                try {
                    if (!MorI.equals("imperial") && !MorI.equals("metric")) {
